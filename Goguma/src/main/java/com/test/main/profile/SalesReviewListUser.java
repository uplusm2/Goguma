...
@WebServlet("/profile/salesReviewListUser.do")
public class SalesReviewListUser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/profile/salesReviewListUser.jsp");
