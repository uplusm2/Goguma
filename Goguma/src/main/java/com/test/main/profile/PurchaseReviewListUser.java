...
@WebServlet("/profile/purchaseReviewListUser.do")
public class PurchaseReviewListUser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ArrayList<ReviewDTO> list = dao.getPurchaseReviewList(map);
		...
		totalCount = dao.getPurchaseTotalPage(map);
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/profile/purchaseReviewListUser.jsp");
