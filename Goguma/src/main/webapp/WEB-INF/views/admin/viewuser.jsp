	...
	<main class="main">
		...
		<div class="container">
			...
			<div class="article">
				...
				<!-- 제목 -->
				<div class="title">
					<h2>${dto.name}<small style="font-size:24px; color:#444; font-weight:500;">(${dto.id})</small>님의 회원정보</h2>
				</div>
	
				<!-- 회원 정보 -->
				<table class="table table-bordered">
					<tr>
						<td class="user-img"><img src="/goguma/asset/img/${dto.path}" style="width: 130px"></td>
						<td class="user-info">
							<p>
