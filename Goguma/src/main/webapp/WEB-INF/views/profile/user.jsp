			...
			<section class="content">
				...
				<div class="grid-container">
					...
					<div>
						...
						onclick="location.href='/goguma/profile/purchaseReviewListOk.do?userId=${userProfileData.id}'">
					</div>
					<div>
						<input type="button" value="판매 후기" class="btn important" 
						onclick="location.href='/goguma/profile/salesReviewListOk.do?userId=${userProfileData.id}'">
					</div>
					<div></div>
					<div class="salesAvg">
